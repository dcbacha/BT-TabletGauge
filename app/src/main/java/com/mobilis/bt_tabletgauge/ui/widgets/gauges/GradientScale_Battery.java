 ...
 */
public class GradientScale_Battery extends ImageView {
    ...
    public GradientScale_Battery(Context context) {
        super(context);
        init();
    }

    public GradientScale_Battery(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
